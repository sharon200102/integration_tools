...
if __name__ == "__main__":
    ...
    tuned_parameters = {'latent_representation_size':32,'projector_klb_coefficient':0.0125,'projector_learning_rate':0.0001,'xgenerator_learning_rate':0.001,'ygenerator_learning_rate':0.001,'discriminator_learning_rate':0.0001,'train_batch_size':32}
