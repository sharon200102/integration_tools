...
def main(fixed_args, tuned_args, trial_id):
    ...
    checkpoint_callback = ModelCheckpoint(monitor=monitor, dirpath=model_checkpoints_folder, save_last=True, mode='min')
...
if __name__ == "__main__":
    ...
    tuned_parameters = {'latent_representation_size': 64, 'projector_klb_coefficient': 0.005,
                        'projector_learning_rate': 0.001, 'xgenerator_learning_rate': 0.005,
                        'ygenerator_learning_rate': 0.005, 'discriminator_learning_rate': 0.0001,
                        'train_batch_size': 64}
